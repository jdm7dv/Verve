...
[assembly: AssemblyCopyright("2000-2020 AlphaSierraPapa for the SharpDevelop Team")]
[assembly: AssemblyVersion(RevisionClass.Major + "." + RevisionClass.Minor + "." + RevisionClass.Build + "." + RevisionClass.Revision)]
[assembly: AssemblyInformationalVersion(RevisionClass.FullVersion + "-406354be")]
...
internal static class RevisionClass
{
	...
	public const string Revision = "9430";
	...
	public const string FullVersion = Major + "." + Minor + "." + Build + ".9430";
}
