...
namespace Microsoft.VisualStudio.Package {
    ...
    /// </summary>
    [ComVisible(true), CLSCompliant(false), ClassInterface(ClassInterfaceType.None)]
#if !WHIDBEY
    ...
    public class HierarchyItemNode : HierarchyNode {
        ...
        public HierarchyItemNode(Project root, HierarchyNodeType type, XmlElement e) {
...
*/
        ...
        public override int SetEditLabel(string label, string strRelPath) {
            ...
            string strOldName = this.FullPath;
