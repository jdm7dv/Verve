...
namespace Microsoft.VisualStudio.Shell{
  ...
  /// </summary>
  public abstract class Package : IVsPackage, IVsInstalledProduct,
    ...
    public virtual int ResetDefaults(uint flags){
      return (int)HResult.E_NOTIMPL;
    }

    public virtual int QueryClose(out int canClose){
      canClose = 1;
      return 0;
    }
    ...
    public virtual int GetAutomationObject(string propName, out object obj){
      obj = null;
      return (int)HResult.E_NOTIMPL;
    }

    public virtual int CreateTool(ref Guid persistenceSlot){
      return (int)HResult.E_NOTIMPL;
    }
    #endregion 
    ...
    public virtual int IdBmpSplash(out uint IdBmp){
      IdBmp = 101;
      return 0;
    }
    ...
    public virtual int IdIcoLogoForAboutbox(out uint IdIcoLogo){
      IdIcoLogo = 100;
      return 0;
    }
    ...
    /// </summary>
    public virtual int OfficialName(out string strOfficialName){
    ...
    /// </summary>
    public virtual int ProductDetails(out string strProductDetails){
    ...
    /// </summary>
    public virtual int ProductID(out string strProductID){
