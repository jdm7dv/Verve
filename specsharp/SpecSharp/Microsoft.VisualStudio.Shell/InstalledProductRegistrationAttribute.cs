...
namespace Microsoft.VisualStudio.Shell 
{
    ...
    public sealed class InstalledProductRegistrationAttribute : RegistrationAttribute 
    {
        ...
        {
            return string.Format("InstalledProducts\\{0}", context.ComponentType.Name);
        }
        ...
        public override void Register(RegistrationContext context) 
        {
            ...
            {
                context.Log.WriteLine(SR.GetString(SR.Reg_NotifyInstalledProduct, context.ComponentType.Name, ProductId));
            }
