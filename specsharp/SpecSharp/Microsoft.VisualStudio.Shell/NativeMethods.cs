...
namespace Microsoft.VisualStudio {
    ...
    public class NativeMethods {
        ...
        // Private constructor: it is not possible to create objects of this class.
       ...
       /// <include file='doc\NativeMethods.uex' path='docs/doc[@for="OleComponentUIManager"]/*' />
        ...
        /// <include file='doc\NativeMethods.uex' path='docs/doc[@for="VSStd97CmdID"]/*' />
        /// <summary>Standard Vs CommandID</summary>
        public enum VSStd97CmdID
        {
            /// <include file='doc\NativeMethods.uex' path='docs/doc[@for="VSStd97CmdID.CmdIdCopy"]/*' />
            CmdIdCopy       = 15,
            /// <include file='doc\NativeMethods.uex' path='docs/doc[@for="VSStd97CmdID.CmdIdCut"]/*' />
            CmdIdCut        = 16,
            /// <include file='doc\NativeMethods.uex' path='docs/doc[@for="VSStd97CmdID.CmdIdPaste"]/*' />
            CmdIdPaste      = 26,
            /// <include file='doc\NativeMethods.uex' path='docs/doc[@for="VSStd97CmdID.CmdIdRedo"]/*' />
            CmdIdRedo       = 29,
            /// <include file='doc\NativeMethods.uex' path='docs/doc[@for="VSStd97CmdID.CmdIdSelectAll"]/*' />
            CmdIdSelectAll  = 31,
            /// <include file='doc\NativeMethods.uex' path='docs/doc[@for="VSStd97CmdID.CmdIdUndo"]/*' />
            CmdIdUndo       = 43,
        };
...
// ALLEND - These are already defined in the VS Interops and should be removed
// RECT
...
// POINT
        ...
        public sealed class ConnectionPointCookie {
            ...
            ~ConnectionPointCookie(){
                #if DEBUG
                System.Diagnostics.Debug.Assert(connectionPoint == null || cookie == 0, "We should never finalize an active connection point. (Interface = " + eventInterface.FullName + ")");
                #endif
                Disconnect();
            }
            ...
            public ConnectionPointCookie(object source, object sink, Type eventInterface, bool throwException){
                ...
                if (source is Microsoft.VisualStudio.OLE.Interop.IConnectionPointContainer) {
                    Microsoft.VisualStudio.OLE.Interop.IConnectionPointContainer cpc = (Microsoft.VisualStudio.OLE.Interop.IConnectionPointContainer)source;
            ...
            /// <include file='doc\NativeMethods.uex' path='docs/doc[@for="ConnectionPointCookie.Disconnect"]/*' />
            /// <devdoc>
        ...
        public static bool IsSamePath(string file1, string file2) {
            ...
            if (uri1.IsFile && uri2.IsFile) {
                return 0 == String.Compare(uri1.LocalPath, uri2.LocalPath, true, System.Globalization.CultureInfo.InvariantCulture);
            }
            return file1 == file2;
        }
        ...
        /// <summary>
        /// Sets a 32-bit (LONG) value at the specified offset into the extra window memory of a window.
        /// </summary>
