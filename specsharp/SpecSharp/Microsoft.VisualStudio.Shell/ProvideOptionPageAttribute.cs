...
namespace Microsoft.VisualStudio.Shell {
    ...
    public sealed class ProvideOptionPageAttribute : RegistrationAttribute {
        ...
        private short   _pageNameResourceID;
        ...
        /// <include file='doc\ProvideOptionPageAttribute.uex' path='docs/doc[@for="ProvideOptionPageAttribute.PageNameResourceID"]' />
        /// <devdoc>
        ///     The native resourceID of the name for this page.
        /// </devdoc>
        public short PageNameResourceID {
            get {
                return _pageNameResourceID;
            }
        }
        
        /// <include file='doc\ProvideOptionPageAttribute.uex' path='docs/doc[@for="ProvideOptionPageAttribute.PageType"]' />
        /// <devdoc>
        ///     The type of this option page.
        /// </devdoc>
        ...
        public override void Register(RegistrationContext context) {
            ...
            using (Key toolsOptionsKey = context.CreateKey(ToolsOptionsPagesRegKey))
            {
                ...
                {
                    pageKey.SetValue(string.Empty, string.Format(CultureInfo.InvariantCulture, "#{0}", PageNameResourceID));
