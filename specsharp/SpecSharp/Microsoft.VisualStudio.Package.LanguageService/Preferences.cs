...
namespace Microsoft.VisualStudio.Package {
    ...
    public class LanguagePreferences : IVsTextManagerEvents2, IDisposable {
        ...
        public int MaxRegions {
            get { return this.maxRegions; }
            set { this.maxRegions = value; }
        }
        ...
        public virtual void InitMachinePreferences(RegistryKey key, string name)
        {
            using (RegistryKey keyLanguage = key.OpenSubKey("languages\\language services\\" + name, false))
            {
                if (keyLanguage != null) {
                    ...
                    this.EnableAutoOutlining = GetBooleanValue(keyLanguage, "AutoOutlining", true);
                    this.MaxRegions = GetIntegerValue(keyLanguage, "MaxRegions", 5000);
                }
            }
        }
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public bool EnableAutoOutlining {
        ...
        public virtual void OnRegisterMarkerType(int iMarkerType) {
        }
        /// <include file='doc\Preferences.uex' path='docs/doc[@for="LanguagePreferences.OnRegisterView"]/*' />
        public virtual void OnRegisterView(IVsTextView view) {
        }
        /// <include file='doc\Preferences.uex' path='docs/doc[@for="LanguagePreferences.OnUnregisterView"]/*' />
        public virtual void OnUnregisterView(IVsTextView view) {
        }

        /// <include file='doc\Preferences.uex' path='docs/doc[@for="LanguagePreferences.OnUserPreferencesChanged2"]/*' />
        public virtual void OnUserPreferencesChanged2(VIEWPREFERENCES2[] viewPrefs, FRAMEPREFERENCES2[] framePrefs, LANGPREFERENCES2[] langPrefs, FONTCOLORPREFERENCES2[] fontColorPrefs) {
