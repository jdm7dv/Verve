...
namespace Microsoft.VisualStudio.Package {
    ...
    [Guid("fc6fe46a-5951-4bd4-a7ad-3254bd60383b")]
    internal enum LanguageServiceCommands {
        RunTasks = 1,
    }
      ...
      */
        ...
        internal void StopThread() {
            if (this.parseThread != null) {
                ...
                this.parseRequestPending.Set();
                if (!ptt.WaitOne(5000, false)) { // give it 5 seconds...
                    // Then kill it, otherwise devenv.exe won't exit.
        ...
        public virtual int CurFileExtensionFormat(string fileName) {
            ...
            string fileext = VsShell.GetFileExtension(fileName);
            ...
            for (int i = 0, n = sa.Length - 1; i < n; i += 2) {
                ...
                if (ext.Length > 1 && string.Compare(ext.Substring(1), fileext, true, CultureInfo.CurrentUICulture) == 0) {
                    return i / 2;
                }
            }
            return -1;
