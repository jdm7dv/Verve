...
namespace Microsoft.VisualStudio.Package {
    ...
    public class Source : IDisposable, IVsTextLinesEvents, IVsFinalTextChangeCommitEvents, IVsHiddenTextClient, IVsUserDataEvents {
        ...
        public Source(LanguageService service, IVsTextLines textLines, Colorizer colorizer) {
            NativeHelpers.TraceRef(textLines, "Source.textLines");
            ...
            this.doOutlining = this.service.Preferences.EnableAutoOutlining;
            if (this.doOutlining) {
                GetHiddenTextSession();
            }
            this.expansionProvider = GetExpansionProvider();
            this.maxRegions = this.service.Preferences.MaxRegions;
        }
        ...
        public virtual void Dispose() {
            ...
            try {
                ...
                //            }
                if (this.textLines != null) {
                    NativeHelpers.TraceRef(this.textLines, "Source.textLines");
                    Marshal.ReleaseComObject(this.textLines);
                    this.textLines = null;
                }
            } catch (COMException) {
            }
        ...
        public virtual TextSpan UncommentBlock(TextSpan span, string blockStart, string blockEnd) {
            ...
            if (span.iStartIndex + blockStart.Length <= startLen && span.iEndIndex - blockStart.Length >= 0) {
                ...
                if (startText == blockStart) {
                    ...
                    endText = this.GetText(linespan.iStartLine, linespan.iStartIndex, linespan.iEndLine, linespan.iEndIndex);
                    if (endText == blockEnd) {
        ...
        public virtual DocumentTask CreateErrorTaskItem(TextSpan span, string filename, string message, TaskPriority priority, TaskCategory category, MARKERTYPE markerType, TaskErrorCategory errorCategory) {
            ...
            if (markerType != MARKERTYPE.MARKER_OTHER_ERROR) {
                ...
                textLineMarker = TextMarkerClient.CreateMarker(textLines, span, markerType, message);
            }
            // create task item
            DocumentTask taskItem = CreateErrorTaskItem(textLineMarker, span, filename);
        ...
        public virtual DocumentTask CreateErrorTaskItem(IVsTextLineMarker textLineMarker, TextSpan span, string filename) {
            return new DocumentTask(this.service.Site, textLineMarker, span, filename);
        }
        ...
        public virtual void BeginParse(bool synchronous) {
            this.dirty = false;
            this.BeginParse(0, 0, new TokenInfo(), ParseReason.Check, this.service.LastActiveTextView, new ParseResultHandler(this.HandleParseResponse), false);
        }
        ...
        public TokenInfo GetTokenInfo(int line, int col) {
            ...
            if (lineInfo != null) {
                //get character info      
                GetTokenInfoAt(lineInfo, col - 1, ref info);
            }
        ...
        public virtual void Completion(IVsTextView textView, TokenInfo info, ParseReason reason) {
            ...
            bool synchronous = (reason == ParseReason.CompleteWord || reason == ParseReason.DisplayMemberList);
            this.BeginParse(line, idx, info, reason, textView, new ParseResultHandler(this.HandleCompletionResponse), synchronous);
        }

        internal void HandleCompletionResponse(ParseRequest req) {
            try {
                if (this.service == null || req.Scope == null || req.Timestamp != this.requestSync)
                    return;

                Trace.WriteLine("Source::HandleCompletionResponse");

                this.lastParseTime = req.parseTime; // for OnIdle loop
                ...
                if (decls.GetCount() > 0 && (this.service.Preferences.AutoListMembers || completeWord || reason == ParseReason.DisplayMemberList)) {
                    this.completionSet.Init(req.View, decls, completeWord);
                }
            } catch (Exception e) {
                Trace.WriteLine("HandleCompletionResponse exception: " + e.Message);
            } catch {
                Trace.WriteLine("HandleCompletionResponse exception");
            }
        }
        ...
        public virtual void MethodTip(IVsTextView textView, int line, int index, TokenInfo info) {
            this.BeginParse(line, index, info, ParseReason.MethodTip, textView, new ParseResultHandler(this.HandleMethodTipResponse), false);
        }
        ...
        internal void HandleMethodTipResponse(ParseRequest req) {
            ...
            fail:
                ...
                Trace.WriteLine("HandleMethodTipResponse exception");
            }
        }
        ...
        public virtual void MatchBraces(IVsTextView textView, int line, int index, TokenInfo info) {
            this.BeginParse(line, index, info, ParseReason.HighlightBraces, textView, new ParseResultHandler(this.HandleMatchBracesResponse), false);
        }
        ...
        internal void HandleMatchBracesResponse(ParseRequest req) {
            try {
                ...
                //highlight
                NativeMethods.ThrowOnFailure(req.View.HighlightMatchingBrace((uint)0, (uint)spans.Length, spans));
                ...
                if (spans.Length>0 && this.service.Preferences.EnableShowMatchingBrace) {
                    ...
                    if (statusBar != null) {
                        ...
                        if (found) {
                            ...
                            string text = this.GetText(span.iStartLine, span.iStartIndex, span.iEndLine, span.iEndIndex);
                ...
                Trace.WriteLine("HandleMatchBracesResponse exception");
            }
        }

        /// <include file='doc\Source.uex' path='docs/doc[@for="Source.OnSyncQuickInfo"]/*' />
        public virtual string OnSyncQuickInfo(IVsTextView textView, int line, int col) {
            // synchronous parse and return data tip text.
            ParseRequest req = this.BeginParse(line, col, new TokenInfo(), ParseReason.Autos, textView, null, true);
        ...
        /// <include file='doc\Source.uex' path='docs/doc[@for="Source.OnSyncGoto"]/*' />
        public virtual string OnSyncGoto(VsCommands cmd, IVsTextView textView, int line, int col, out TextSpan span) {
            ...
            ParseRequest req = this.BeginParse(line, col, new TokenInfo(), ParseReason.Goto, textView, null, true);
            AuthoringScope scope = req.Scope;
            if (scope != null) {
        ...
        public virtual void GetPairExtents(IVsTextView textView, int line, int col, out TextSpan span) {
            ...
            ParseRequest req = this.BeginParse(line, col, new TokenInfo(), ParseReason.MatchBraces, textView, null, true);
            ...
            for (i = 0; i < matches; i++) {
                ...
                if (TextSpanHelper.ContainsInclusive(m.a, line, col)) {
                    span.iStartLine = m.a.iStartLine;
                    span.iStartIndex = m.a.iStartIndex;
                    span.iEndLine = m.b.iStartLine;
                    span.iEndIndex = m.b.iStartIndex;
                    break;
                } else if (TextSpanHelper.ContainsInclusive(m.b, line, col)) {
                    span.iStartLine = m.b.iStartLine;
                    span.iStartIndex = m.b.iStartIndex;
                    if (t != null) {
                        span.iEndLine = t.c.iStartLine;
                        span.iEndIndex = t.c.iStartIndex;
                    } else {
                        span.iEndLine = m.a.iStartLine;
                        span.iEndIndex = m.a.iStartIndex;
                    }
                    break;
                } else if (t != null && TextSpanHelper.ContainsInclusive(t.c, line, col)) {
                    span.iStartLine = t.c.iStartLine;
                    span.iStartIndex = t.c.iStartIndex;
                    span.iEndLine = m.a.iStartLine;
                    span.iEndIndex = m.a.iStartIndex;
                    break;
                }
        ...
        internal ParseRequest BeginParse(int line, int idx, TokenInfo info, ParseReason reason, IVsTextView view, ParseResultHandler callback, bool sync) {
...
#if TRACE_PARSING
            Trace.WriteLine((sync ? "BeginParse:" : "BeginAsyncParse:") + request.Timestamp + " dirty=" + this.dirtySpan.iStartLine + "," + this.dirtySpan.iStartIndex + "," + this.dirtySpan.iEndLine + "," + this.dirtySpan.iEndIndex);
#endif
            if (sync) {
                request.Scope = this.service.ParseSource(request);
                if (callback != null) callback(request);
            } else {
                this.service.BeginParse(request, callback);
            }
            return request;
        }
        ...
        internal void HandleParseResponse(ParseRequest req) {
            try {
                ...
                if (req.Timestamp == this.requestSync && req.Sink.ProcessHiddenRegions) {
            ...
            for (int i = 0, n = errors.Count; i < n; i++) {
                ...
                while (pos < taskProvider.Tasks.Count) {
                    ...
                    if (current is DocumentTask) {
                        ...
                        if (NativeMethods.IsSamePath(current.Document, filename) && current.Text == message && TextSpanHelper.IsSameSpan(span, dt.Span) && current.Category == category && current.Priority == priority && dt.ErrorCategory == errorCategory) {
                            pos++;
                            merged++;
                            found = true;
                ...
                if (pos == errorMax) {
                    ...
                    span.iStartIndex = span.iEndIndex;
                    span.iStartLine = span.iEndLine;
                    DocumentTask error = this.CreateErrorTaskItem(span, localFile, maxMsg, TaskPriority.High, TaskCategory.CodeSense, MARKERTYPE.MARKER_INVISIBLE, TaskErrorCategory.Error);
        ...
        public virtual void ProcessHiddenRegions(ArrayList hiddenRegions) {
            ...
            bool foundInvalidSpan = false ;
#endif                
            if (hiddenRegions.Count > 0) {                
                int count = hiddenRegions.Count;
                int max = this.maxRegions;
                int i = 0;
                NewHiddenRegion[] list = new NewHiddenRegion[max];
                while( i < count && (matched + added < max)) {
                ...
                while (i > 0 && NativeMethods.Failed(hr)) {
                    hr = session.AddHiddenRegions((int)CHANGE_HIDDEN_REGION_FLAGS.chrNonUndoable, i, list, null);
                    if (NativeMethods.Failed(hr)) {
                        i = (this.maxRegions /= 2);
                    }
                }
            ...
            Trace.WriteLine(String.Format(CultureInfo.InvariantCulture, "Hidden Regions: Matched={0}, Removed={1}, Addded={2} in {3} ms", matched, removed, added, diff));
#endif
        ...
        public virtual int GetTipText(IVsHiddenRegion region, string[] result) {
            if (result != null && result.Length > 0) {
                ...
                result[0] = this.GetText(aspan[0].iStartLine, aspan[0].iStartIndex, aspan[0].iEndLine, aspan[0].iEndIndex);
            }
    ...
    [CLSCompliant(false)]
    public class CompletionSet : IVsCompletionSet, IDisposable {
        ImageList imageList;
        bool displayed;
        bool completeWord;
        ...
        public virtual int OnCommit(string textSoFar, int index, int selected, ushort commitChar, out string completeWord) {
            ...
            if (isCommitChar) {
                ...
                // Ping our ViewFilter to trigger auto-complete.  This must be done AFTER the text editor inserts
                // the completeWord we are about to return.  This must also be done because when the user uses
                // a mouse double click to select intellisense our ViewFilter will not be on the stack and
                // therefore cannot trigger autocomplete.  This solves that problem.
                IVsUIShell shell = (IVsUIShell)this.source.LanguageService.Site.GetService(typeof(IVsUIShell));
                if (shell != null) {
                    //char noop = '\0';
                    object pvaIn = null;
                    int hr = shell.PostExecCommand(ref VsMenus.guidStandardCommandSet2K, (uint)VsCommands2K.AUTOCOMPLETE, 0, ref pvaIn);
                }

                // the method signature was changed so that this can return S_FALSE if necessary
                return NativeMethods.S_OK;
            }
        nocommit:
