...
namespace Bio
{
    ...
    public class MetadataListItem<T>
    {
        ...
        internal MetadataListItem(SerializationInfo info, StreamingContext context)
        {
            if (info == null)
            {
            ...
            Key = (string)info.GetValue("MetadataDataListItem:Key", typeof(string));
            FreeText = (string)info.GetValue("MetadataDataListItem:FreeText", typeof(string));
            SubItems = (Dictionary<string, T>)info.GetValue("MetadataDataListItem:SubItems", typeof(Dictionary<string, T>));
        }
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("MetadataDataListItem:Key", Key);
            info.AddValue("MetadataDataListItem:FreeText", FreeText);
            info.AddValue("MetadataDataListItem:SubItems", SubItems);
        }
