...
{
    /// <summary>
    /// A VirtualQualitativeSequenceList is used to store huge list of sequences where all items in the
    ...
    public class VirtualQualitativeSequenceList : IList<ISequence>, IList<IQualitativeSequence>
    {
        ...
        public void CopyTo(IQualitativeSequence[] array, int arrayIndex)
        {
            ...
            foreach (IQualitativeSequence seq in this as IQualitativeSequence)
            {
                array[index++] = seq;
            }
        }
