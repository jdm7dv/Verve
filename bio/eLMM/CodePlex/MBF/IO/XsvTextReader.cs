...
namespace Bio.IO
{
    ...
    /// </summary>
    public class XsvTextReader : BioTextReader
    {
        ...
        /// </summary>
        public override string LineHeader
        {
            get
            {
                return string.Empty;
        ...
        /// </summary>
        public override string LineData
        {
            get
            {
                return Line;
        ...
        #endregion Defaulted Properties of BioTextReader
        ...
        public string[] Fields
        {
            get
            {
                ...
                if (_fields == null)
                {
                    ...
                    _fields = Line.Split(Separators);
                    if (TrimWhiteSpace)
                    {
                        for (int i = 0; i < _fields.Length; i++)
                        {
                            _fields[i] = _fields[i].Trim();
                        }
                    }
                }
        ...
        public string CommentLine
        {
            get
            {
                return HasCommentLine ? base.Line.Substring(1) : null;
            }
        }
        ...
        public bool HasCommentLine
        {
            get
            {
                return 
                  ...
                  base.HasLines && !string.IsNullOrEmpty(base.Line) && // do we have a valid line?
                  CommentPrefixes.Contains(base.Line[0]); // is it a valid comment line?          
            }
        }
        ...
        public XsvTextReader (TextReader reader, char[] separators, bool ignoreWhiteSpace, bool hasHeader)
            : base(reader)
        {
        ...
        /// </summary>
        public override void GoToNextLine ()
        {
            base.GoToNextLine();
            // skip comment lines
