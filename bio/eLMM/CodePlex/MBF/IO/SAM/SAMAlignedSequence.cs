...
namespace Bio.IO.SAM
{
    ...
    public class SAMAlignedSequence : IAlignedSequence
    {
        ...
        /// <summary>
        /// VAlidates header info.
        /// </summary>
        /// <returns>Returns empty string if the header is valid; otherwise returns a string containing error message.</returns>
        public string IsValidHeader()
        {
            return _seqHeader.IsValid();
        }
