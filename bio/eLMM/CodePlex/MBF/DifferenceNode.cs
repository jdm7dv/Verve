    ...
    public class DifferenceNode
    {
            ...
            int sequence2Index)
        {
            ...
            if (sequence1Length != 0)
            {
                ...
                {
                    replaceStr = sequence2.ToString().Substring(sequence2Start, sequence2Length);
                }
                else
                {
                ...
                if (sequence1.MoleculeType == MoleculeType.Protein)
                {                    
                    if (replaceStr.Length > 0)
                    {
                        sourceStr = sequence1.ToString().Substring(sequence1Start, sequence1Length);
