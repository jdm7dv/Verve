...
#pragma warning restore 1591
        {
            Helper.CheckCondition(val.Length == 1, "Every val must be a single character. " + val);
...
#pragma warning restore 1591
        ...
        /// </summary>
        public static double StaticMissingValue = double.NaN;
        /// <summary>
        /// The special value used to represent missing values internally. Always double.NaN.
        /// </summary>
        public static double StaticStoreMissingValue = double.NaN;
