...
namespace Bio.Util
{
    ...
    public abstract class ValueConverter
    {
        static public ValueConverter<char, T> GetCharToGeneric<T>()
        {
            ...
            throw new Exception(string.Format("Don't have a predefined converter for char to {0}.", typeof(T)));
        }
    ...
    internal class CharACTGToDouble0123Converter : ValueConverter<char, double>
    {
        ...
        static public char Zero123DoubleToACTG(double d)
        {
            ...
            else throw new Exception("cannot convert value d=" + d + " to a nucleotide");
        }
        ...
        static public double ACTGTo0123Double(char c)
        {
            ...
            {
                throw new Exception("Error converting ACTG? characters to nucleotides: found a character that doesn't belong:" + c);
            }
        }
    }
    ...
    internal class Char01ToMinusOneOne : ValueConverter<char, double>
    {
        ...
        static public double ZeroOneCharToMinus11Double(char c)
        {
            ...
            Helper.CheckCondition(false, "Expect char to be '0' or '1'");
            return double.NaN;
        }
        ...
        static public char Minus11DoubleAsZeroOneChar(double r)
        {
            ...
            Helper.CheckCondition(false, "Expect doubles to be -1 or 1");
            return default(char);
        }
    ...
    internal class Char01ToBool : ValueConverter<char, bool?>
    {
        ...
        {
            Helper.CheckCondition(r.HasValue, "Expect bool? to true or false");
            if (r.Value)
            {
                return '1';
            }
