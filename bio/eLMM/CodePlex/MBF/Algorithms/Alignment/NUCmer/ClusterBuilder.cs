...
namespace Bio.Algorithms.Alignment
{
    ...
    public class ClusterBuilder : IClusterBuilder
    {
        ...
        {
            int clusterSize, seperation, firstMatchIndex, secondMatchIndex;
            int counter1, counter2;
            ...
            for (counter1 = 0; counter1 < matches.Count - 1; counter1++)
            {
                ...
                for (counter2 = counter1 + 1; counter2 < matches.Count; counter2++)
                {
                    ...
                    seperation = matches[counter2].SecondSequenceStart - endIndex;
                    if (seperation > MaximumSeparation)
                    {
                        break;
                    }
                    ...
                    diagonalDifference = Math.Abs(
                            ...
                            - diagonalIndex);
                    if (diagonalDifference <= Math.Max(FixedSeparation, SeparationFactor * seperation))
                    {
