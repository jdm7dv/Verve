...
namespace Bio
{
    ...
    public class Sequence : IVirtualSequence
    {
        ...
        public Sequence(IAlphabet alphabet, IEncoding encoding, string sequence) :
            this(alphabet, encoding, sequence, null) { }
        ...
        public Sequence(IAlphabet alphabet, IEncoding encoding, ISequenceEncoder encoder, ISequenceDecoder decoder, string sequence) :
            this(alphabet, encoding, encoder, decoder, sequence, null) { }
        ...
        /// calculated.
        /// </param>
        internal Sequence(IAlphabet alphabet, string sequence, SequenceStatistics statistics) :
            this(alphabet, EncodingMap.GetDefaultMap(alphabet).Encoding, sequence, statistics) { }
        ...
        /// calculated.
        /// </param>
        internal Sequence(IAlphabet alphabet, IEncoding encoding, string sequence, SequenceStatistics statistics) :
            this(alphabet, encoding, new SequenceEncoder(encoding), new SequenceDecoder(encoding), sequence, statistics) { }
        ...
        /// calculated.
        /// </param>
        internal Sequence(IAlphabet alphabet, IEncoding encoding, ISequenceEncoder encoder, ISequenceDecoder decoder, string sequence, SequenceStatistics statistics)
        {
            Alphabet = alphabet;
            _encoding = encoding;
            _encoder = encoder;
        ...
        public void InsertRange(int position, string sequence)
        {
            ...
            if (VirtualSequenceProvider == null)
            {
                byte[] encodedValues = _encoder.Encode(sequence);
        ...
        public void Replace(int position, ISequenceItem item)
        {
            ...
            if (VirtualSequenceProvider == null)
            {
                ...
                byte encodedValue = _encoder.Encode(item);
                if (_areStatisticsValid)
                {
        ...
        public void Replace(int position, char character)
        {
            ...
            if (VirtualSequenceProvider == null)
            {
                byte encodedValue = _encoder.Encode(character);
                if (_areStatisticsValid)
                {
                    _statistics.Remove(_decoder.Decode(_valueList[position]));
        ...
        public int IndexOf(ISequenceItem item)
        {
            if (item != null)
            {
                ...
                if (VirtualSequenceProvider == null)
                {
                    ...
                    {
                        byte value = _encoder.Encode(item);
        ...
        public ISequenceItem this[int index]
        {
            ...
            set
            {
                ...
                byte encodedValue = _encoder.Encode(value);
                if (_areStatisticsValid)
                {
        ...
        private byte[] ConvertToByteArray()
        {
            ...
            {
                byte encodedValue = _encoder.Encode(VirtualSequenceProvider[i]);
