    ...
    public class ClustalWParameters
    {
        ...
        static ClustalWParameters()
        {
            RequestParameter requestParameter = new RequestParameter(
                    ...
                    "string",
                    null);
            _parameters.Add(Email, requestParameter);
            ...
            _parameters.Add(Action, requestParameter);
            ...
            requestParameter = new RequestParameter(
                    ...
                    "string",
                    null);
            _parameters.Add(RunOption, requestParameter);
            ...
            _parameters.Add(CpuOption, requestParameter);
            ...
            requestParameter = new RequestParameter(
                    ...
                    "string",
                    null);
            _parameters.Add(ClusterOption, requestParameter);
            ...
            _parameters.Add(FormatAlignment, requestParameter);
            ...
            _parameters.Add(OrderOption, requestParameter);
            ...
            requestParameter = new RequestParameter(
                    ...
                    "string",
                    null);
            _parameters.Add(ProteinMatrixOption, requestParameter);
            ...
            requestParameter = new RequestParameter(
                    ...
                    "string",
                    null);
            _parameters.Add(DnaMatrixOption, requestParameter);
            ...
            requestParameter = new RequestParameter(
                    ...
                    "double",
                    null);
            _parameters.Add(GapOpeningPenalty, requestParameter);
            ...
            requestParameter = new RequestParameter(
                    ...
                    "double",
                    null);
            _parameters.Add(GapExtensionPenalty, requestParameter);
            ...
            requestParameter = new RequestParameter(
                    ...
                    "double",
                    null);
            _parameters.Add(GapSeparationPenalty, requestParameter);
            ...
            requestParameter = new RequestParameter(
                    ...
                    "string",
                    null);
            _parameters.Add(GapEnd, requestParameter);
            ...
            requestParameter = new RequestParameter(
                    ...
                    "string",
                    null);
            _parameters.Add(GapHydrophilic, requestParameter);
            ...
            requestParameter = new RequestParameter(
                    ...
                    "string",
                    null);
            _parameters.Add(KimuraOption, requestParameter);
            ...
            requestParameter = new RequestParameter(
                    ...
                    "int",
                    null);
            _parameters.Add(BootstrapOption, requestParameter);
            ...
            requestParameter = new RequestParameter(
                    ...
                    "string",
                    null);
            _parameters.Add(LabelTreeOption, requestParameter);
            ...
            _parameters.Add(FormatTree, requestParameter);
        }
        ...
        public void Add(string parameterName, string parameterValue)
        {
            if (!_parameters.ContainsKey(parameterName))
            {
                string message = String.Format(CultureInfo.InvariantCulture,
                        Resource.PARAMETER_UNKNOWN,
                        parameterName);
                throw new Exception(message);
            }

            RequestParameter param = _parameters[parameterName];
