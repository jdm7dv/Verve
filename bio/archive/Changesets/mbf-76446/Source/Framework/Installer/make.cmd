...
IF EXIST Bio.msi del /F Bio.msi
...
CALL "%WIXTOOLS%\heat" dir "%SETUPTMPFOLDER%\Microsoft Biology Foundation\MBF" -srd -dr FRAMEWORKFOLDER -gg -g1 -nologo -cg FrameworkComponentGroup -sfrag -template:fragment -ke -out %SETUP%\source\FrameworkComponents.wxs
...
xcopy /y /q /e "%SETUPTMPFOLDER%\Microsoft Biology Foundation\MBF" %OUTDIR%
...
xcopy /y /q "%SETUPTMPFOLDER%\Microsoft Biology Foundation\BioConsoleApplicationTemplate.zip" %OUTDIR%
xcopy /y /q /e "%SETUPTMPFOLDER%\Microsoft Biology Foundation\Bio.TemplateWizard.dll" %OUTDIR%
...
CALL "%WIXTOOLS%\light" -nologo -sice:ICE05 -sw1076 -out %SETUP%\Bio.msi Framework.wixobj SDKComponents.wixobj VStemplateComponents.wixobj FrameworkUILib.wixlib -loc %UI%\WixUI_en-us.wxl -ext "%WIXTOOLS%\WixUIExtension.dll" -ext "%WIXTOOLS%\WixUtilExtension.dll"
...
echo ************************************************************
echo  Bio msi creation complete
echo ************************************************************
