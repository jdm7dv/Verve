...
namespace Bio.Algorithms.Alignment
{
    ...
    public class PairwiseSequenceAlignment : IPairwiseSequenceAlignment
    {
        ...
        /// </summary>
        private SequenceAlignment seqAlignment;

        /// <summary>
        /// List of alignments.
        /// </summary>
        private List<PairwiseAlignedSequence> alignedSequences
        ...
        public IList<IAlignedSequence> AlignedSequences
        {
            get
            {
                ...
                return alignedSequences.ConvertAll(PAS => PAS as IAlignedSequence).AsReadOnly();
            }
        }
        ...
        public void AddSequence(PairwiseAlignedSequence pairwiseAlignedSequence)
        {
            if (IsReadOnly)
            {
                Trace.Report(Properties.Resource.READ_ONLY_COLLECTION_MESSAGE);
