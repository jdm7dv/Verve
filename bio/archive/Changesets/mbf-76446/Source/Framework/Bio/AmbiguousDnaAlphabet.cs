...
namespace Bio
{
    ...
    public class AmbiguousDnaAlphabet : DnaAlphabet
    {
        ...
        protected AmbiguousDnaAlphabet()
        {
            ...
            AddNucleotide(this.AC, (byte)'m');
            AddNucleotide(this.GA, (byte)'r');
            AddNucleotide(this.GC, (byte)'s');
            AddNucleotide(this.AT, (byte)'w');
            AddNucleotide(this.TC, (byte)'y');
            AddNucleotide(this.GT, (byte)'k');
            AddNucleotide(this.GCA, (byte)'v');
            AddNucleotide(this.ACT, (byte)'h');
            AddNucleotide(this.GAT, (byte)'d');
            AddNucleotide(this.GTC, (byte)'b');
            AddNucleotide(this.Any, (byte)'n');
