...
namespace Bio.IO.Xsv
{
    ...
    public class XsvSnpReader : XsvTextReader, ISnpReader
    {
        ...
        private SnpItem MakeSnpForCurrentLine ()
        {
            ...
            snpItem.Chromosome = (byte)ushort.Parse(GetFieldValue(FieldNames.Chromosome), CultureInfo.InvariantCulture);
            snpItem.Position = int.Parse(GetFieldValue(FieldNames.Position), CultureInfo.InvariantCulture);
