...
namespace Bio
{
    ...
    public class AmbiguousProteinAlphabet : ProteinAlphabet
    {
        ...
        {
            Name = Properties.Resource.AmbiguousProteinAlphabetName;
            HasAmbiguity = true;
            ...
            AddAminoAcid(this.X, (byte)'x');
            AddAminoAcid(this.Z, (byte)'z');
            AddAminoAcid(this.B, (byte)'b');
            AddAminoAcid(this.J, (byte)'j');
            ...
            foreach (byte symbol in symbols)
            {
                if (!validValues.Contains(symbol))
                {
                    throw new ArgumentException(string.Format(
                        CultureInfo.CurrentCulture, Properties.Resource.INVALID_SYMBOL, symbol, Name));
                }
