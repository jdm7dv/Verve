    ...
    public class SimpleConsensusResolver : IConsensusResolver
    {
        ...
        public byte GetConsensus(byte[] items)
        {
            ...
            else
            {
                ...
                {
                    return this.SequenceAlphabet.GetConsensusSymbol(aboveThresholdSymbols);
                }
                else
                {
                    return this.SequenceAlphabet.GetConsensusSymbol(new HashSet<byte>(symbolFrequency.Keys));
                }
            }
        }
    }
