...
namespace Bio
{
    ...
    public class RnaAlphabet : IAlphabet
    {
        ...
        protected RnaAlphabet()
        {
            ...
            basicSymbols.Add(this.U); basicSymbols.Add((byte)char.ToLower((char)this.U, CultureInfo.InvariantCulture));
            basicSymbols.Add(this.Gap);

            // Add nucleotides
            this.AddNucleotide(this.A, (byte)'a');
            this.AddNucleotide(this.C, (byte)'c');
            this.AddNucleotide(this.G, (byte)'g');
            this.AddNucleotide(this.U, (byte)'u');
            this.AddNucleotide(this.Gap);
        ...
        protected void AddNucleotide(byte nucleotideValue, params byte[] otherPossibleValues)
        {
            // Verify whether the nucleotide value or other possible values already exist or not.
