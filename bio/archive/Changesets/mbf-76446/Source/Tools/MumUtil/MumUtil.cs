...
namespace MumUtil
{
    class MumUtil
    {
        class CommandLineOptions
        {
            ...
            //
            [Argument(ArgumentType.AtMostOnce, HelpText = "Show the help information with program options and a description of program operation.", ShortName = "h")]
            ...
            [DefaultArgument(ArgumentType.MultipleUnique, HelpText = "Query file(s) containing the query strings")]
