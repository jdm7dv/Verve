...
namespace Bio.Algorithms.SuffixTree
{
    ...
    public class MultiWaySuffixTree : ISuffixTree
    {
            ...
            for (queryIndex = 0; queryIndex <= querySequenceLength - minLengthOfMatch; queryIndex++)
            {
                ...
                if (edgesFound.Count > 0)
                {
                    ...
                    while (edgesFound.Count > 0)
                    {
                        ...
                        {
                            EdgesFound newEdgeFound = new EdgesFound() { Edge = edge.SuffixLink[0], LengthOfMatch = matchLength - 1 };
                            ...
                            newEdgeFound.StartIndexesFromPreviousMatchPathEdge = overlappingStartIndexesForNextQueryIndex;
        ...
        private static bool ValidateMatch(long queryIndex, long referenceIndex, long matchLength, SortedList<long, Dictionary<long, SortedList<long, SortedSet<long>>>> previousMatches, out Match match)
        {
